static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CHARLOT_CITY - 1] = {MAP_GROUP(CHARLOT_CITY), MAP_NUM(CHARLOT_CITY), 30, 15},
    [HEAL_LOCATION_STATIS_TOWN - 1] = {MAP_GROUP(STATIS_TOWN), MAP_NUM(STATIS_TOWN), 4, 7},
    [HEAL_LOCATION_ROUTE201_2 - 1] = {MAP_GROUP(ROUTE201_2), MAP_NUM(ROUTE201_2), 22, 23},
    [HEAL_LOCATION_ROUTE201_3 - 1] = {MAP_GROUP(ROUTE201_3), MAP_NUM(ROUTE201_3), 22, 23},
};

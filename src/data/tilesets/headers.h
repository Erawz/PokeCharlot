...
const struct Tileset gTileset_gTileset_CharlotGeneral =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_gTileset_CharlotGeneral,
    .palettes = gTilesetPalettes_gTileset_CharlotGeneral,
    .metatiles = gMetatiles_gTileset_CharlotGeneral,

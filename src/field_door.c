...
//static const u8 sDoorAnimTiles_PokeCenterCharlot[] = INCBIN_U8("graphics/door_anims/poke_center_charlot.4bpp");
...
//static const u8 sDoorAnimPalettes_PokeCenterCharlot[] = {1, 1, 1, 1, 1, 1, 1, 1};

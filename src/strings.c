...
const u8 gText_LureEffectsLingered[] = _("Mais le LEURRE précédent est\ntoujours actif.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnFrostbiteHealed[] = _("{STR_VAR_1} n'est plus gelé.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnGainedExp[] = _("{STR_VAR_1} a gagné {STR_VAR_2} points d'EXP!{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnGainedExpAndElevatedToLvVar3[] = _("{STR_VAR_1} a gagné {STR_VAR_2} points d'EXP\net monte au N. {STR_VAR_3}!");
...
ALIGNED(4) const u8 gText_PkmnCantBeTraded[] = _("Ce POKéMON ne peut pas être échangé.");
...
const u8 gText_PressingSpeedRankings[] = _("Classement Pressing-Speed");
...
const u8 gText_StartMenuTime[] = _("HEURE");
const u8 gText_AM[] = _("");
const u8 gText_PM[] = _("");

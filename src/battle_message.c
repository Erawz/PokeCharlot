...
static const u8 sText_PkmnGotFrostbite[] = _("{B_EFF_NAME_WITH_PREFIX} a eu des engelures!");
...
static const u8 sText_PkmnHurtByFrostbite[] = _("{B_ATK_NAME_WITH_PREFIX} souffre\nde ses engelures!");
...
static const u8 sText_PkmnFrostbiteHealed[] = _("{B_DEF_NAME_WITH_PREFIX} les engelures ont été soignés");
static const u8 sText_PkmnFrostbiteHealed2[] = _("{B_ATK_NAME_WITH_PREFIX} les engelures ont été soignés");
static const u8 sText_PkmnFrostbiteHealedBy[] = _("{B_ATK_NAME_WITH_PREFIX} est dégelé\npar {B_CURRENT_MOVE}!");
...
static const u8 sText_PkmnInSnapTrap[] = _("{B_DEF_NAME_WITH_PREFIX} a été piégé\npar un piège!");
...
static const u8 sText_PkmnCantUseMoveThroatChop[] = _("{B_ACTIVE_NAME_WITH_PREFIX} ne peut pas\nutiliser {B_CURRENT_MOVE} en raison de Throat Chop!\p");
...
static const u8 sText_SnowContinues[] = _("La neige continue.");
static const u8 sText_SnowStopped[] = _("La neige s'est arrêtée.");
...
static const u8 sText_PkmnSentToPC[] = _("{B_DEF_NAME} est envoyé au\nPC {B_PC_CREATOR_NAME}.");
...
static const u8 sText_PkmnsItemHealedFrostbite[] = _("{B_LAST_ITEM} du {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nle guérit de ses engelures!");
